                    ...
                    <table class="w-full border-collapse border border-gray-400">
                        ...
                        <tbody>
                            @foreach($customer as $customer)
                                <tr class="bg-white">
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->NIC }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->fullname }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->getGenderDetails->gender }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->dob }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->address }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->contactnumber }}</td>
                                    <td class="border border-gray-400 px-4 py-2">{{ $customer->email ?? '—' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
